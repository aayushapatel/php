                    ...
                    <tr>
                        ...
                        <td>
                            <input type="date" name="account[dateOfBirth]" id="dateOfbirth"
                                value='<?php echo getData('account', 'dateOfBirth'); ?>'>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="account[phoneNumber]" id="phoneNumber" placeholder="Phone Number"
                                value='<?php echo getData('account', 'phoneNumber'); ?>'>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="account[email]" id="email" placeholder="Email"
                                value='<?php echo getData('account', 'email'); ?>'>
            ...
            <table>
                <div>
                    <tr>
                        ...
                        <td><input type="text" name="address[addressOneLine]" id="addressOne"
                                value="<?php echo getData('address', 'addressOneLine'); ?>">
                ...
                <div>
                    <tr>
                        ...
                        <td><input type="text" name="address[addressTwoLine]" id="addressTwo"
                                value="<?php echo getData('address', 'addressTwoLine'); ?>">
                ...
                <tr>
                    ...
                    <td><input type="text" name="address[companyName]" id="companyName"
                            value="<?php echo getData('address', 'companyName'); ?>">
                    </td>
                </tr>
                </div>
                <div>
                    <tr>
                        ...
                        <td><input type="text" name="address[city]" id="city"
                                value="<?php echo getData('address', 'city'); ?>"></td>
                    </tr>
                </div>
                <div>
                    <tr>
                        ...
                        <td><input type="text" name="address[state]" id="state"
                                value="<?php echo getData('address', 'state'); ?>"></td>
                    </tr>
                </div>
                <div>
                    <tr>
                    ...
                    ?>
                                <option value=<?php echo $country?>
                                    <?php echo (in_array(getData('address','country'),[$country]))? $selected : ""   ?>>
                ...
                <div>
                    <tr>
                        ...
                        <td><input type="text" name="address[postalCode]" id="postalCode"
                                value="<?php echo getData('address', 'postalCode'); ?>">
                ...
                <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="other[describe]" id="describe" cols="30"
                                    rows="5"><?php echo getData('other', 'describe'); ?></textarea>
                    ...
                    <div>
                        ...
                        foreach($years as $yearRadio): ?>
                                <input type="radio" name="other[years]" value="<?php echo $yearRadio?>"
                                    <?php echo (in_array(getData('other','years'),[$yearRadio]))? $selected : "" ?>><?php echo $yearRadio?>
                                <?php endforeach; ?>
                            ...
                            <td>
                                ...
                                <select name="other[clients]" id="clients">
                                    ...
                                    <option value=<?php echo $clients?>
                                        <?php echo (in_array(getData('other','clients'),[$clients]))? $selected : ""   ?>>
                    ...
                    ?>
                                <input type="checkbox" name="other[inTouch][<?php  echo $inTouch?>]"
                                    ...
                                    <?php echo (in_array($inTouch,(getData('other','inTouch',[]))))? $selected : "" ?>>
                                <?php echo $inTouch?>
                                <?php endforeach; 
                     ?>
                    ...
                    ?>
                                    <option value="<?php echo $hobbies?>"
                                        <?php echo (in_array($hobbies,(getData('other','hobbies',[]))))? $selected: ""   ?>>
